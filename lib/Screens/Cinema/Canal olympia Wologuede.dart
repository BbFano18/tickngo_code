...
class WologuedeScreen extends StatefulWidget {
  final int centreId;
  const WologuedeScreen({Key? key, required this.centreId}) : super(key: key);

  @override
  State<WologuedeScreen> createState() => _WologuedeScreenState();
}

class _WologuedeScreenState extends State<WologuedeScreen>{
  ...
  Future<void> _loadMovies() async {
    try {
      ...
      // Récupérer les libellés pour chaque film
              ...
              child: Column(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: movie.image != null && movie.image!.isNotEmpty
                        ? Image.network(
                      // Correction ici: utilisation de baseUrl2 comme dans le _buildMovieCard
                      '${ApiConfig.baseUrl2}storage/${movie.image!}',
                      height: 250,
                      width: double.infinity,
                      fit: BoxFit.cover,
                            ...
                            MaterialPageRoute(
                              builder: (context) => ReservationScreen(
                                reservation: Reservation(
                                  ...
                                  eventLocation: "Canal Olympia Wologuede",
                                  ticketPrices: {
                                  },
                                  categoryPrices: {
                                  },
