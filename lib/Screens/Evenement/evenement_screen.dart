                            ...
                            MaterialPageRoute(
                              builder: (context) => ReservationScreen(
                                reservation: Reservation(
                                  ...
                                  categoryPrices: {
                                    "Standard": event.tarifStandard.toDouble(),
                                    "VIP": event.tarifVIP.toDouble(),
                                    "VVIP": event.tarifVVIP.toDouble(),
                                  },
                                  type: ReservationType.evenement,
                                  centreName: "Centre d'événements",
                                ),
                              ),
                            ),
                          );
